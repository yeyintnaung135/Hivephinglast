                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class=""
                                    ...
                                    <div class="caption">
                                        <h3 class="" style="color:white;">Send Mail to {{$inves->name}} </h3>
                                        <p class="c-font-lowercase" style="color:#c1c1c1;"></p>
                                    </div>
                                    <form action="{{url('entra/reply_mail_for_bplan/'.$msg_id)}}" method="post"
                                        ...
                                        <input type="hidden" placeholder="Your Email" name="to_user"
                                                value="{{$inves->user_id}}" class="form-control input-md">
