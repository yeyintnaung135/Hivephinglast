    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <form action="{{ url('inves_profile/profile_detail/'.$data->id) }}" method="post">
                ...
                <!-- {{ csrf_field() }} adds the cross site request forgery token
                    ...
                    <a href="#change" role="button" class="pull-right" data-toggle="modal"> If you will change
                        Password </a>
            ...
            <div id="change" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{ url('inves_profile/changepassword/'.$data->id) }}">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-default pull-left" data-dismiss="modal">Close
                                </button>
