            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="" style="padding:18px; border:2px solid #67809F;background-color:#67809F;">
                                    <div class="caption">
                                        <h3 class="" style="color:white;">Send Mail to {{$com->name}} </h3>
                                        <p class="c-font-lowercase" style="color:#c1c1c1;"></p>
                                    </div>
                                    <form action="{{url('entra/send_mail_for_project/'.$project_data->id)}}" method="post"
                                            enctype="multipart/form-data"
                                            class="form-horizontal">
                                        {{csrf_field()}}
                                        <input type="hidden" placeholder="Your Name" name="from_user"
                                                value="{{$from_id}}" class="form-control input-md">
                                        <input type="hidden" placeholder="Your Email" name="to_user"
                                                value="{{$to_id}}" class="form-control input-md">
                                        <div class="form-group">
                                            <input type="text" name="title" placeholder="Title" class="form-control input-md" required/>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="wysihtml5 form-control" data-error-container="#editor1_error" rows="8" name="subject" placeholder="Write comment here ..." required></textarea>
                                        </div>
