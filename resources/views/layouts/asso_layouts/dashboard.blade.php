@extends('layouts.asso_layouts.plane')
    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
            <div class="page-logo">
                <a href="index.html"> <img src="{{'log'}}" alt="logo" class="logo-default"/> </a>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            <li>
                                <a href="app_inbox.html"> <i class="icon-envelope-open"></i> My Inbox
                                    <span class="badge badge-danger"> 3 </span> </a>
                            </li>
                            <li>
                                <a href="app_todo.html"> <i class="icon-rocket"></i> My Tasks
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item ">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <a href="{{url('/asso/dashboard')}}" class="nav-link "> <i class="icon-bar-chart"></i>
                    ...
                    <li class="nav-item ">
                        ...
                        <a href="{{url('/asso/asso_detail')}}" class="nav-link "> <i class="icon-user"></i>
                            <span class="title">Association Detail </span> <span class="selected"></span> </a>

                    </li>
                    <li class="nav-item ">

                        <a href="{{url('/asso/members')}}" class="nav-link "> <i class="icon-users"></i>
                            <span class="title">Members </span> <span class="selected"></span> </a>

                    </li>
                    <li class="nav-item ">

                        <a href="{{url('/asso/requests')}}" class="nav-link "> <i class="icon-paper-plane"></i>
                            <span class="title">Join Requests </span> <span class="selected"></span> </a>

                    </li>

                    <li class="nav-item  ">
                        <a href="javascript:;" class="nav-link nav-toggle"> <i class="icon-bulb"></i>
                            <span class="title">Activity</span> <span class="arrow"></span> </a>
                        <ul class="sub-menu">
                            <li class="nav-item  ">
                                <a href="{{url('asso/activities')}}" class="nav-link "> <span class="title">Your Activities</span>
                            ...
                            <li class="nav-item  ">
                                <a href="{{url('asso/create_activity')}}" class="nav-link "> <span class="title">Create New Activity</span>
                    ...
                    <li class="nav-item  ">
                        <a href="{{url('asso/events')}}" class="nav-link nav-toggle"> <i class="icon-puzzle"></i>
