...
<script src="{{asset('global/plugins/ie8.fix.min.js')}}"></script><![endif]-->
...
<script>
    $(document).ready(function () {
        $("#country").click(function () {
            ...
            $.get("http://www.hivephing.com/get_cities_ajax/"+id, function (data) {
    ...
    setInterval(function(){$("#loadingoverlay").css('display,none')},3000);
</script>
@yield('angul')
