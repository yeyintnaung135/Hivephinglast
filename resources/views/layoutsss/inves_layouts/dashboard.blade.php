@extends('layouts.inves_layouts.plane')
                ...
                <ul class="nav navbar-nav pull-right" >
                    ...
                    <li class="dropdown dropdown-user" >
                        ...
                        <ul class="dropdown-menu dropdown-menu-default" >
                            <li >
                                <a href="{{url('inves_profile/profile_detail/'.Auth::user()->id)}}"> <i class="icon-user"></i> My Profile
                                </a>
                            </li >
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item" >
                        <a href="javascript:;" class="nav-link nav-toggle" >
                            ...
                            <span class="title" >Pannels</span >
                            <span class="arrow" ></span >
                        </a >
                        <ul class="sub-menu" >
                            {{--<li class="nav-item">--}}
                                {{--<a href="{{url('inves_require_detail')}}" class="nav-link " >--}}
                                    {{--<span class="title" >Investor Pannel</span >--}}

                                {{--</a >--}}
                            {{--</li>--}}
                            <li class="nav-item  " >
                                <a href="{{url('entra_dashboard')}}" class="nav-link " >
                                    <span class="title" >Company Pannel</span >
                    ...
                    <li class="nav-item {{$inves_p}}" >
                            <a href="{{url('inves/business_proposals')}}" class="nav-link " >
                                <i class="icon-bar-chart" ></i >
                                <span class="title" >Business Proposal</span >
