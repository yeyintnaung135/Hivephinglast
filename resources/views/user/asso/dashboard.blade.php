                            ...
                            <div class="number" >
                                <h3 class="font-purple-soft" >
                                    <h3 class="font-blue-sharp" >
                                        @php
                                            $association=\Illuminate\Support\Facades\DB::table('association')->where([['user_id','=',Auth::user()->id]])->first();

                                            $members_array=explode(',',$association->members_id);
                                            $count_members=count($members_array);

                                        @endphp
                                        <span data-counter="counterup" data-value="{{$count_members}}" ></span >
                                    </h3 >
                                </h3 >
                        ...
                        <div class="display" >
                            <div class="number" >
                                <h3 class="font-purple-soft" >
                                    <h3 class="font-blue-sharp" >
                                        @php
                                            $request=\Illuminate\Support\Facades\DB::table('request_tojoin')->where([['asso_user','=',Auth::user()->id],['confirm','=','no']])->first();
                                        @endphp
                                        <span data-counter="counterup" data-value="{{count($request)}}" ></span >
                                    </h3 >
                                </h3 >
                                        ...
                                        <li class="selected" data-date="16/01/2014" >
                                            ...
                                            <div class="mt-author" >
                                                ...
                                                <div class="mt-author-name" >
                                                    <a href="javascript:;"
                                                            class="font-blue-madison" >Andres Iniesta</a >
                                                </div >
                                        ...
                                        <li data-date="15/09/2014" >
                                            ...
                                            <div class="mt-content border-grey-steel" >
                                                ...
                                                <p >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto,
                                                    ...
                                                    qui ut.</p >
                                                <a href="javascript:;"
                                                        class="btn btn-circle green-sharp" >Read More</a >
                                            </div >
                                        </li >
