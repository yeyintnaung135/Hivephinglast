    ...
    <div class="page-content-wrapper" >
            ...
            <div class="page-content" >
                ...
                <div class="btn-group btn-group-sm btn-group-solid">
                    <a href="{{url('asso/business_news')}}" type="button" class="btn red">Business News</a>
                    <a href="{{url('asso/othernews')}}" type="button" class="btn blue">Other News</a>
                </div>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                        ...
                        <div class="portlet box blue-hoki" >
                            ...
                            <div class="portlet-body" >
                                <div class="scroller" style="height:200px" data-rail-visible="1"
                                    ...
                                    <br /><img src="{{asset('images\login\bg1.jpg')}}" width="152"
                                            style=" vertical-align: text-top;float:left;margin:9px;" ></img >{{$n->des}} </div >
