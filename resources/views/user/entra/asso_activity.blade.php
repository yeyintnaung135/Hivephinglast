        ...
        <div class="page-content" >
            ...
            <div class="page-bar" >
                <ul class="page-breadcrumb" >
                    <li >
                        <a href="#" class="list-name">Activities</a >
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title page_title" > Association {{$name}}'s Activities</small>
            </h1 >
                        ...
                        <div class="portlet box blue-hoki" >
                            ...
                            <div class="portlet-body" >
                                <div class="scroller" style="height:200px" data-rail-visible="1"
                                    ...
                                    <br /> <img src="{{url('users/asso/photo/'.$d->image)}}" width="192" height="100"
