...
?>
<!-- BEGIN CONTAINER -->
<div class="col-xs-12" style="background-color:white;padding-bottom:22px;" onload="setv({{$for_show}})">
    <!-- BEGIN SIDEBAR -->
    <!-- END SIDEBAR -->
    <!-- BEGIN CONTENT -->
    <div class="col-sm-12">
        ...
        <div class="page-content" style="min-height: 1432px;">
            ...
            <h2 style="font-size:19px;font-weight:bolder;color:#32c5d2;">တိုက္အသစ္အား ေဆးသုတ္ျခင္းလုပ္ငန္း</h2>

            <div class="clearfix">
                <button type="button" class="btn blue-hoki" onclick="setv(1)"> အတြင္းေဆးသုတ္ျခင္:</button>
                <button type="button" class="btn blue-madison" onclick="setv(2)">အျပင္ေဆးသုတ္ျခင္း</button>
                <button type="button" class="btn blue-hoki" onclick="setv(3)">မ်က္နွာက်က္အားေဆးသုတ္ျခင္း</button>
            </div>
            <script>
            ...
            <div class="row">
                ...
                <!-- Begin: Demo Datatable 1 -->
                    ...
                    <div id='show1' style="display:block;">
                        ...
                        <h4 style="font-weight:bolder;color:#32c5d2;"> အတြင္းေဆးသုတ္ျခင္:</h4>
                        <br>
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','normal'],['main_type','=','2'],['second_type','=','1']]);
                        @endphp
                        {{--edit--}}
                        @if($check->count() != 0)
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                                ...
                                <div class="col-md-2 col-lg-3"
                                    ...
                                    <input type="hidden" name="main_type" class="main_setv" value="2"/>
                                                        ...
                                                        <table class="table table-bordered no-footer">
                                                            ...
                                                            <tr role="row" class="filter">
                                                                ...
                                                                <td rowspan="1" width="10%" colspan="1">
                                                                    <input type="number"
                                                                           class="form-control form-filter input-sm"
                                                                           name="cost_ex_Selar" placeholder=""
                                                                           required/>
                                                            ...
                                                            <tr role="row" class="filter">
                                                                ...
                                                                <td rowspan="1" width="10%" colspan="1">
                                                                    ...
                                                                    <input type="number"
                                                                           class="form-control form-filter input-sm"
                                                                           name="cost_ex_Putty" placeholder=""
                                                                           required/>
                                                            ...
                                                            <tr role="row" class="filter">
                                                                ...
                                                                <td rowspan="1" width="10%" colspan="1">
                                                                    <input type="number"
                                                                           class="form-control form-filter input-sm"
                                                                           name="cost_ex_Color" placeholder=""
                                                                           required/>
                                                            ...
                                                            <tr role="row" class="filter">
                                                                ...
                                                                <td rowspan="1" width="10%" colspan="1">
                                                                    <input type="number"
                                                                           class="form-control form-filter input-sm"
                                                                           name="cost_ex_Testion" placeholder=""
                                                                           required/>
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','middle'],['main_type','=','2'],['second_type','=','1']]);
                        @endphp
                        @if($check->count() != 0 )
                            {{--edit--}}
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','high'],['main_type','=','2'],['second_type','=','1']]);
                    ...
                    <div id='show2' style="display:none;">
                        {{--for 1 2--}}
                        {{--//normal seciton--}}
                        <h4 style="font-weight:bolder;color:#32c5d2;">အျပင္ေဆးသုတ္ျခင္း</h4>
                        <br>
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','normal'],['main_type','=','2'],['second_type','=','2']]);
                        @endphp
                        {{--edit--}}
                        @if($check->count() != 0)
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','middle'],['main_type','=','2'],['second_type','=','2']]);
                        @endphp
                        @if($check->count() != 0 )
                            {{--edit--}}
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','high'],['main_type','=','2'],['second_type','=','2']]);
                    ...
                    <div id='show3' style="display:none;">
                        {{--for 1 2--}}
                        {{--//normal seciton--}}
                        <h4 style="font-weight:bolder;color:#32c5d2;">မ်က္နွာက်က္အားေဆးသုတ္ျခင္း</h4>
                        <br>
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                            $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','normal'],['main_type','=','2'],['second_type','=','3']]);
                        @endphp
                        {{--edit--}}
                        @if($check->count() != 0)
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                            $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','middle'],['main_type','=','2'],['second_type','=','3']]);
                        @endphp
                        @if($check->count() != 0 )
                            {{--edit--}}
                            <div class="col-xs-12" style="border:2px solid #e4e8fb">
                        ...
                        @php
                            $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                            $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','high'],['main_type','=','2'],['second_type','=','3']]);
