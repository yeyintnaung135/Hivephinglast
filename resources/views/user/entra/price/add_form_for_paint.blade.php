    ...
    <div class="col-sm-12">
        ...
        <div class="page-content" style="min-height: 1432px;">
           ...
           @include('user.entra.price.catforpaint')
            <h4 style="font-size:19px;font-weight:bolder;color:#32c5d2;">တိုက္အေဟာင္း အားျပန္လည္ ျပဳျပင္
                ေဆးသုတ္လုပ္ငန္း</h4>
            ...
            <div class="row">
                ...
                <!-- Begin: Demo Datatable 1 -->
                    ...
                    @php
                        ...
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','normal'],['main_type','=','1'],['second_type','=','1']]);
                    @endphp
                    {{--edit--}}
                    @if($check->count() != 0)
                        <div class="col-xs-12" style="border:2px solid #e4e8fb">
                            ...
                            <div class="col-md-2 col-lg-3"
                                ...
                                <input type="hidden" name="main_type" id="main_setv" value="1"/>
                                <input type="hidden" name="second_type" id="setv" value="1"/>
                    ...
                    @php
                        $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','middle'],['main_type','=','1'],['second_type','=','1']]);
                    @endphp
                    @if($check->count() != 0 )
                        {{--edit--}}
                        <div class="col-xs-12" style="border:2px solid #e4e8fb">
                    ...
                    @php
                        $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','high'],['main_type','=','1'],['second_type','=','1']]);
                ...
                <div id="show2" style="display:none;" class="col-md-12">
                {{--<div class="note note-danger">--}}
                {{--<p> NOTE: The below datatable is not connected to a real database so the filter and sorting is just simulated for demo purposes only. </p>--}}
                {{--</div>--}}
                <!-- Begin: Demo Datatable 1 -->
                    ...
                    @php
                        $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','normal'],['main_type','=','1'],['second_type','=','2']]);
                    @endphp
                    {{--edit--}}
                    @if($check->count() != 0)
                        <div class="col-xs-12" style="border:2px solid #e4e8fb">
                            ...
                            <div class="col-md-2 col-lg-3"
                                ...
                                Normal class
                                <input type="hidden" name="pctype" value="normal"/>
                                <input type="hidden" name="main_type" class="main_setv" value="1"/>
                    ...
                    @php
                        $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','middle'],['main_type','=','1'],['second_type','=','2']]);
                    @endphp
                    @if($check->count() != 0 )
                        {{--edit--}}
                        <div class="col-xs-12" style="border:2px solid #e4e8fb">
                            ...
                            <div class="col-md-2 col-lg-3"
                                ...
                                <input type="hidden" name="pctype" value="middle"/>
                                <input type="hidden" name="main_type" id="main_setv" value="1"/>
                                <input type="hidden" name="second_type" id='setv' value="2"/>
                    ...
                    @php
                        $get_com_id=DB::table('company')->where('user_id',Auth::user()->id)->first();
                        $check=DB::connection('mysql_service')->table('Company_with_paint')->where([['com_id','=',$get_com_id->id],['pctype','=','high'],['main_type','=','1'],['second_type','=','2']]);
