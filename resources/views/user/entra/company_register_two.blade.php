...
<div class="col-xs-12" style="background-color:white;padding-bottom:22px;">
    <div class="col-sm-12">
        <div class=""
             style="margin-left:8%;margin-right:4%;width:80%;background-color:#e4e44d;margin-top:34px;border-radius:4px !important;height:43px;">
            <div style="margin-left:4%;padding-top:1%;font-size:17px;font-weight:bolder;">
                <a href=""> Home </a> >>> Company Registration Form
            </div>
        </div>
        <form action='{{url('company_register_form_three')}}' enctype="multipart/form-data" role="form" method="post"
              class="form-horizontal" style="margin-top:22px;">
            {{csrf_field()}}
            <div class="row">

                <div class="form-group {{ $errors->has('website') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label input-title f_label">If you have the company website please
                        fill your company website address
                    </label>
                ...
                <div class="form-group {{ $errors->has('facebook') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control f" name="facebook" placeholder="optional"
                               value="{{old('facebook')}}">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <select name="registration_status" class="form-control f" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <select name="investment" class="form-control f">
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                ...
                <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label input-title f_label">Description</label>
                ...
                <div class="form-group {{ $errors->has('logo') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label input-title f_label">Logo ( Optional )</label>
                ...
                <div class="form-group {{ $errors->has('year_esta') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control f" name="year_esta"
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-8">
                    <button type="submit" class="btn btn-lg green pull-right f" style="float:right;">Save And Continue
                        To Other Page
                    </button>
                </div>
