        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span class="list-name">Events </span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title page_title"> Events
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i>{{$in->title}} </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <strong>{{$in->title}}</strong>
                                        <br/>
                                        <img src="{{asset('upload/events/'.$in->photo)}}" width="152"
                                                style=" vertical-align: text-top;float:left;margin:9px;"></img>
                                        {!!$in->description!!}
                                    </div>
                                <strong style="color:#67809f;">Start Date:<{{\Carbon\Carbon::parse($in->start_date)->toDateString()}}> </strong>
                                <strong style="color:#67809f;">Start Date:<{{\Carbon\Carbon::parse($in->end_date)->toDateString()}}> </strong>
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body">
                                ...
                                <strong>{{$n->title}}</strong>
                                    <br/> <img src="{{asset('upload/events/'.$n->photo)}}" width="152"
                                               style=" vertical-align: text-top;float:left;margin:9px;"></img>
                                   {!!$n->description!!}
                                </div>
                                <strong style="color:#67809f;">Start Date:<{{\Carbon\Carbon::parse($n->start_date)->toDateString()}}> ---</strong>
                                <strong style="color:#67809f;">End Date:<{{\Carbon\Carbon::parse($n->end_date)->toDateString()}}> ---</strong>
