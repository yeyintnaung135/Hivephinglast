...
<div class="col-xs-12" style="background-color:#ddedf2;padding-bottom:22px;">
    ...
    <div class="col-xs-12" style="text-align: center;font-size:22px;font-weight:bolder;margin-top:12px;">Business News
    </div>
                ...
                <div class="portlet box yellow">
                    ...
                    <div class="portlet-body">
                        <div style="overflow:auto;height:300px;">
                            ...
                            <br/>
                            <img src="{{asset('upload/'.$n->image)}}" width="152" style=" vertical-align: text-top;float:left;margin:9px;">
