    ...
    <div class="col-sm-12">
        <div class=""
            ...
            <div style="margin-left:4%;padding-top:1%;font-size:17px;font-weight:bolder;">
                <a href=""> Home </a> >>> Add Your Portfolio
            </div>
        </div>
        <br>
        <br>
                ...
                <div class="form-body">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('project_name') ? ' has-error' : '' }}">
                            <label class="col-md-3 control-label input-title f_label">Porject's Name
                            </label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label input-title f_label">
                                Date of completion
                            </label>
