        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span class="list-name"> Other News </span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            ...
            <div class="btn-group btn-group-sm btn-group-solid">
                <a href="{{url('business_news')}}" type="button" class="btn red">Business News</a>
                <a href="{{url('othernews')}}" type="button" class="btn blue">Other News</a>
            </div>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
