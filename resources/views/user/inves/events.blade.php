                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body">
                                <div class="scroller" style="height:200px" data-rail-visible="1"
                                    ...
                                    <br/> <img src="{{asset('upload/events/'.$in->photo)}}" width="152"
                                            style=" vertical-align: text-top;float:left;margin:9px;"></img>
                                    {{$in->description}}
                                </div>
                                <strong style="color:#67809f;">Start Date:<{{$in->start_date}}> ---</strong>
                                <strong style="color:#67809f;">End Date:<{{$in->end_date}}></strong>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body">
                                ...
                                <strong style="color:#67809f;">Start Date:<{{$n->start_date}}> ---</strong>
                                <strong style="color:#67809f;">End Date:<{{$n->end_date}}></strong>
