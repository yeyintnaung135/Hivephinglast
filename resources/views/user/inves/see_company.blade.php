...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> {{$data->name}}'s detail</small>
            </h1>
            <h1 class="page-title page_title">
                {{$data->name}} Company's detail
                <a href="{{url('inves/other_company_detail/'.$data->user_id.'/show_case/products')}}">
                        ...
                        <div class="portlet solid blue-hoki">
                            <div class="portlet-title">
                                ...
                                <div style="float:right;" >
                                    <a href="{{url('inves/see_company_activities/'.$data->id)}}" class="btn green"> Activities <i class="fa fa-plus"></i>
                                    </a>
                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <h5 style="display:inline;font-weight:bolder;color: #5f5963;">City</h5>:<span style="color:#5f5963;font-weight:bold;"> &nbsp; {{$data->city_id}}</span>
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <h5 style="display:inline;font-weight:bolder;color: #5f5963;">Expire Date</h5> :
                                    <span style="color:#5f5963;font-weight:bold;"> &nbsp; {{$data->expire_date}}</span>
                                </div>
                                <div class="col-md-12 col-lg-6" style="margin-bottom:4px">
                                    <h5 style="display:inline;font-weight:bolder;color: #5f5963;">Website Link </h5>
                                    : <span style="color:#5f5963;font-weight:bold;"> &nbsp;<a href="{{$data->website}}">{{$data->website}}  <span class="fa fa-arrow-right"></span></a> </span>
                                </div>
                                <div class="col-md-12 col-lg-6" style="margin-bottom:4px">
                                    <h5 style="display:inline;font-weight:bolder;color: #5f5963;">Facebook Link </h5>
                                    : <span style="color:#5f5963;font-weight:bold;"> &nbsp;<a href="{{$data->facebook}}">{{$data->facebook}}   <span class="fa fa-arrow-right"></span></a> </span>
                                </div>
                                &nbsp;
                                &nbsp;
                                &nbsp;
                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                <div class="col-md-12 col-lg-6">
                                    ...
                                    <ul style="list-style:none;padding-left:2px;">
                                        <li><i class="fa fa-user" style="float:left;"></i><h5
                                                    style="color:#5f5963;font-weight:bold;"> &nbsp; {{$data->name}}</h5>
                                        </li>
            ...
            <div class="row" style="float:right;">
                <div class="col-xs-12">
                    <a href="{{url('entra/reply_message/'.$data->user_id)}}"  class="btn btn-lg btn-success">Send Mail</a>
                </div>
            </div>
            @if(Auth::user()->type == 1 )
                <div class="row" style="float:right;">
                    <div class="col-xs-12">
                        <button type="button" onclick="go({{$data->id}})"  class="btn btn-lg btn-success">Edit</button>
                    </div>
                </div>
