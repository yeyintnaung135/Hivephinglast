                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-settings font-dark">Reply Message</i>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="c-contact"
                                ...
                                <div class="caption">
                                    <h3 class="" style="color:white;">Send message to {{$com->name}}</h3>
                                ...
                                <form action="{{url('inves/reply_message')}}" method="post" enctype="multipart/form-data"
                                      class="form-horizontal">
                                    {{csrf_field()}}
                                    <input type="hidden" placeholder="Your Name" name="from_user" value="{{Auth::user()->id}}" class="form-control input-md" >
                                    <input type="hidden" placeholder="Your Email" name="to_user" value="{{$com->user_id}}" class="form-control input-md" >
