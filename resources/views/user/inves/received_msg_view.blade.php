...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Received Message
                <small></small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="c-contact" style="padding:18px; border:2px solid #67809F;background-color:#67809F;">
                            <div class="caption" >
                                ...
                                <button type="button" class="btn green-meadow" onclick="reply('{{url('inves/reply_message/'.$data->from_user)}}')"><span class="fa fa-reply">&nbsp;</span>Reply</button>
