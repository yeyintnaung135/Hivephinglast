...
-->
<body width="100%" style="margin: 0; mso-line-height-rule: exactly; background-color: #0267d3;">
<div style="width: 100%; background-color: #0267d3; text-align: left;">
    <!--[if mso | IE]>
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
           style="background-color: #0267d3;">
        <tr>
            <td>
    <![endif]-->
    ...
    <div style="max-width: 680px; margin: 0 auto;" class="email-container">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 auto;">
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{ $message->embed('public/images/logo/logo.png') }}" alt="alt_text" border="0"
                         style="height: auto; width:112px; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #0267d3;">
                </td>
            </tr>
            <!-- Email Header : END -->
                                    ...
                                    <tr>
                                        <td class="button-td button-td-primary"
                                            ...
                                            <a class="button-a button-a-primary"
                                               href="http://www.hivephing.com/companies/entra/construct_projects"
                                               style="background: #e2bd09; border: 1px solid #e2bd09; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; display: block; border-radius: 4px;"><span class="button-link" style="color:#ffffff">Go To See</span></a>
                                        </td>
                                    </tr>
                                </table>
                                <!-- Button : END -->
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 680px;">
            <tr>
                <td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 15px; text-align: center; color: #d2d0d0;">
                    <br><br>
                    HivePhing Co,Ltd.<br>
                    အမွတ္ (112) ျမင္သာ(၉) လမ္း၊ ေတာင္ဥကၠလာပ ျမိဳ႕နယ္ ၊ ရန္ကုန္ျမိဳ႕ <span
